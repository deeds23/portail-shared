              ...
              <li>
                <div class="flex justify-between items-center px-4 max-w-screen-xl mx-auto">
                  <div class="flex gap-3">
                    ...
                    <NuxtLink v-if="userStore.hasGroup('Test-acces-1')" to="/app/formulaire" external class="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded transition text-white">🚀 Formulaire</NuxtLink>
                    
                    <NuxtLink v-if="userStore.hasGroup('Test-acces-2')" to="/app/carte" external class="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded transition text-white">🚀 Carte</NuxtLink>
